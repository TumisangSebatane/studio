...
export const MOCK_DOCUMENTS: Document[] = [
  {
    ...
    content: `
      ...
      <p class="mb-4">Key provisions include the rights of data subjects, the obligations of data controllers, and the powers of the Data Protection Commission. The Act aims to ensure that personal information is handled in a way that respects the privacy of individuals.</p>
      <h3 class="font-headline text-lg mt-6 mb-2 text-primary">Part I - Preliminary</h3>
      <p class="mb-4">This part covers the short title, commencement, interpretation, and application of the Act. It defines key terms such as "personal data", "data subject", and "processing".</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p class="mb-4">Discusses the essential elements for a valid contract: offer, acceptance, consideration, intention to create legal relations, and capacity of the parties.</p>
    `,
  },
];
